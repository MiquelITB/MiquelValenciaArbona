...
import { MapPin, GraduationCap, Wrench, Briefcase, Mail, Phone, Car, Laptop, Palette, Layout as LayoutIcon } from "lucide-react";
    ...
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="max-w-[var(--page-max-width)] mx-auto px-4 py-16 sm:py-24 relative z-10">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <AnimatedSection delay={0.1}>
              <div className="flex flex-col gap-3 p-6 rounded-xl border border-border/40 bg-card/40 backdrop-blur-md">
            ...
            <AnimatedSection delay={0.2}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full">
                ...
                <AnimatedSection delay={0.2}>
                  ...
                  {/* 2. Úsala en una etiqueta img */}
                  <img 
                  src={miFoto} 
                  alt="Miquel Valencia Arbona" 
                  className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-4 border-primary shadow-xl mb-4"
                  />
                  </div>
                </AnimatedSection>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* COLUMNA IZQUIERDA: FORMACIÓN Y COMPETENCIAS DIGITALES */}
          <div className="lg:col-span-1 space-y-8">
            <AnimatedSection delay={0.3}>
              <div className="p-6 rounded-xl border border-border/40 bg-card/40 backdrop-blur-md">
          ...
          {/* COLUMNA DERECHA: EXPERIENCIA LABORAL DETALLADA */}
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-sm text-muted-foreground">
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          ...
                          <li>Cálculo de consumo y propuestas de iluminación.</li>
                          <li>Realización de fichas técnicas y propuestas de mejora.</li>
